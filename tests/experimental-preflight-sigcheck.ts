...
describe("signature-verifier", () => {
  ...
  it("verifies hardcoded signature for 'mynameisjulien'", async () => {
    ...
    const signerPubkey = new PublicKey("x4EJH892FzJt7wmLaiD26dh1kkkwqqzggNcKMp2uXJQ");
    ...
    const messageHash = Buffer.from(
      "a32e22ef166a8a5a112e9bc3acaf81693b8b67b4ca9d4399b0117c5cb0ddeb75",
      "hex"
    );
    ...
    const signature = Buffer.from(
      "b0addeb4f02572173f523a30316d5c2c6cf8b6b348330cba0aa029573a9daff70889a7366c6d0703885ff2179f0ab8d6e0e782fb1374b8e12af44d73f2ac5306",
      "hex"
    );
    ...
    if (!signerPubkey.equals(new PublicKey("x4EJH892FzJt7wmLaiD26dh1kkkwqqzggNcKMp2uXJQ")))
